...
const Formulario = () => {
  ...
  return (
    ...
    <h1 className='text-center text-4xl md:text-5xl text-cyan-500 font-bold mb-6'>
      Forma un hábito en solo 30 días
    </h1>
  
    <form
      onSubmit={handleSubmit}
      className='flex flex-col items-center bg-gray-800 shadow-2xl shadow-gray-700 mt-8 p-6 sm:p-8 w-full max-w-md mx-auto rounded-2xl transform transition-all duration-500 hover:scale-105'
    >
      <label className='text-2xl md:text-3xl text-center text-cyan-400 mb-4' htmlFor="habito">
        ¿Qué hábito deseas crear?
      </label>
      <input
        ref={nombreHabitos}
        className='rounded-full p-3 text-lg text-gray-900 focus:ring-4 focus:ring-cyan-400 outline-none transition-all duration-300 w-full'
        type="text"
        id="habito"
        name="habito"
